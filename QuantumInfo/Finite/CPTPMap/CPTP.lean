...
private theorem matrixMap_fin_1_piProd
  ...
  simp only [Matrix.reindex_apply, Matrix.piProd, Matrix.of_apply,
    ...
    MatrixMap.submatrix_apply, Matrix.submatrix_apply,
    Equiv.funUnique_apply, Equiv.funUnique_symm_apply, Matrix.single,
    show (1 : Fin 1) = 0 from Subsingleton.elim _ _,
    show (default : Fin 1) = 0 from Subsingleton.elim _ _]
  apply congrFun; apply congrFun; apply congrArg
  ext x y; simp [Matrix.submatrix_apply, Matrix.of_apply, uniqueElim,
    funext_iff, Unique.forall_iff, eq_comm]
...
theorem fin_1_piProd
  ...
  apply CPTPMap.ext
  simpa [CPTPMap.piProd] using matrixMap_fin_1_piProd Λi
